...
<template>
  <div class="bg-white">
    ...
    <Link :href="route('all-forum.allforum')" class="flex">
      <p class="flex text-black font-medium text-base ml-12 md:text-xl md:ml-24 lg:text-2xl lg:ml-32">
        <ChevronLeftIcon class="w-5 h-6 md:w-6 md:h-7 lg:w-7 lg:h-8" />Back To Forum
      </p>
    </Link>
    <br />
    <br />
    <div class=" max-w-xs mx-auto overflow-hidden md:max-w-5xl lg:max-w-7xl">
      <div
        ...
        <div class="">
            ...
            <div class="flex">
              ...
              <div class="mt-1.5">
                ...
                <div class="mt-4 md:mt-6">
                  <div class="flex ml-3 text-black items-center text-sm md:text-xl">
          ...
          <div class=" mt-7 flex max-w-xs overflow-hidden mx-auto md:max-w-xl  lg:max-w-3xl">
              <a
          ...
          <div>
            <div class="py-4 md:py-6 md:ml-24 lg:p-8">
              <div class="flex">
                <UserCircleIcon class="text-sky-900 w-10 h-10 md:w-12 md:h-12 lg:w-14 lg:h-14"></UserCircleIcon>
                <div class="mt-1.5">
                  <div class="ml-6 uppercase tracking-wide text-sm font-semibold">
                    {{ comment.user.name }}
                  </div>
