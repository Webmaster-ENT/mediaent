...
<template>
  <div class="bg-white">
    ...
    <Link :href="route('all-forum.allforum')" class="flex">
      <p class="flex mx-36 text-xl font-bold">
        <ChevronLeftIcon class="w-8 h-7" />Back To Article
      </p>
    </Link>
    <br />
    <br />
    ...
    >
      <div class="md:flex">
        <div class="p-8">
          <div class="flex">
            <UserCircleIcon class="text-sky-900 w-14 h-14"></UserCircleIcon>
            <div class="mt-1.5">
          ...
          <div class="mt-7 tracking-wide mx-auto py-auto flex-none">
            <a
              ...
              href="#comment"
            >
              <b class="mx-14 text-white md:mx-56 lg:mx-96">Answer Question</b>
            </a>
          </div>
        </div>
      </div>
